...
function initPro() {
    $("#proviBackTable").html("");
    $("#div").html("");
    $("#proviBackTable").append(" <tr class=\"firstTr\">\n" +
        "              <th width=\"10%\">后台人员ID</th>\n" +
        "              <th width=\"20%\">账号</th>\n" +
        "              <th width=\"10%\">姓名</th>\n" +
        "              <th width=\"10%\">密码</th>\n" +
        "              <th width=\"10%\">创建时间</th>\n" +
    ...
    function getPage(data) {
        $(data.list).each(function () {
            ...
            $("#proviBackTable").append("<tr>\n" +
                ...
                "\t\t\t\t\t</td>\n" +
                "\t\t\t\t\t<td>\n" +
                "\t\t\t\t\t<span>" + this.userPassword + "</span>\n" +
                "\t\t\t\t\t</td>\n" +
                "\t\t\t\t\t<td>\n" +
                "\t\t\t\t\t<span>" + this.creationDate + "</span>\n" +
                "\t\t\t\t\t</td>\n" +
                "                <td>\n" +
                "                    <a href=\"/back/userBackUpdateOne?id="+this.id+"\">修改</a>\n" +
            ...
            $(".delApp").click(function () {
                ...
                $.post("/back/delBack/"+id,AppDel,"text");
